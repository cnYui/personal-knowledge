...
- **悬浮式知识面板** - 在页面中提供可自由拖拽、可左右吸附隐藏的悬浮面板，不影响正常阅读
- **通用网页摘录** - 在普通网页中选中文字后，可直接保存到个人知识库
- **平台增强导航** - 在已支持 AI 平台中，可识别用户问题并生成导航列表
...
- 插件会在普通网页和已支持 AI 平台页面右侧显示「个人知识库」浮动面板
- 可通过标题左侧拖拽点把面板移动到页面任意位置
- 拖到页面左侧或右侧边缘后，面板会自动吸附隐藏
- 在普通网页模式中：
  - 不显示消息搜索、顶部/底部跳转和导航列表
  - 只保留知识摘录能力
- 在平台增强模式中：
  - 点击条目可平滑跳转到对应对话位置
  - 当前位置会自动高亮显示
